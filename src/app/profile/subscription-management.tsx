                ...
                {stripeSubscription ? (
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                ${stripeSubscription.plan.amount / 100} / {stripeSubscription.plan.interval}
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <p>Status: {stripeSubscription.status}</p>
                            <p>Current period end: {new Date(stripeSubscription.current_period_end * 1000).toLocaleDateString()}</p>
                            {stripeSubscription.cancel_at_period_end && (
                                <p className="text-yellow-500">Your subscription will cancel at the end of the current period.</p>
                            )}
                        </CardContent>
                        <CardFooter className="flex justify-between">
                            ...
                            {!stripeSubscription.cancel_at_period_end && (
                                <Button onClick={handleCancelSubscription} disabled={isLoading} variant="destructive">
                                    Cancel Subscription
                                </Button>
                            )}
                        </CardFooter>
